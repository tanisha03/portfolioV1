...
The greatest strength for these kirana store is its ubiquity and nurtured trust from the friendly neighbourhood. The three crore merchants and kirana shop owners, who generate direct and indirect livelihoods for over 20 crore people, form the backbone of India's commerce ecosystem. 
...
[Bounce Kirana](https://breadlake.in/kirana) is a wonderful example highlighting how kiranas can be strategically utilised to solving for mobility in smaller towns of India and build revenue in a way which is never thought. Catering to the last-mile connectivity, supply chain on scooter and distributed ownership. Surprisingly, there has been a positive movement towards the adoption of technology by such kirana stores.

![Bounce Kirana to provide mobility support](./images/bounce.png)

Also, JioMart, Dunzo, Swiggy and likes want to ride the trust earned by India’s kirana stores. More so ever since by Coronavirus wherein people started panic-shopping for groceries from their nearest stores and resorting to getting it delivered instantly. Consumer spending at kirana stores are still 22% higher than pre-Covid levels.
